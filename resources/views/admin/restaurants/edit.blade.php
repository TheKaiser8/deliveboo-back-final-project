    ...
    <div class="container mt-5">
        ...
        @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="city" name="city" placeholder="Inserisci la città del tuo ristorante" value="{{old('city', $restaurant->city)}}">
            </div>
            <div class="mb-3">
                <label for="street_address" class="form-label"><h6>Indirizzo*</h6></label>
                <input type="text" class="form-control" id="street_address" name="street_address" placeholder="Inserisci l'indirizzo del tuo ristorante" value="{{old('street_address', $restaurant->street_address)}}">
            </div>
            <div class="mb-3">
                <label for="postal_code" class="form-label"><h6>Codice Postale*</h6></label>
                <input type="text" class="form-control" id="postal_code" name="postal_code" placeholder="Inserisci il codice postale" value="{{old('postal_code', $restaurant->postal_code)}}">
            </div>
            <div class="mb-3">
